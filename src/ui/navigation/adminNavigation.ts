    ...
    items: [
      {
        ...
        href: '/admin/products',
        label: 'Products',
        description: 'Saved views, listings, prices, photos, categories, and variants',
        icon: Package,
        aliases: ['catalog', 'items', 'listings', 'cards', 'merchandise', 'missing sku', 'draft products'],
      },
      {
        id: 'collections',
        href: '/admin/products',
        label: 'Collections',
        description: 'Group products for merchandising, featured shelves, and campaigns',
        icon: Tag,
      ...
      },
      {
        ...
        description: 'Draft supplier orders, track inbound value, and manage vendor references',
        icon: Truck,
        aliases: ['transfers', 'purchase orders', 'supplier orders', 'po', 'incoming stock', 'vendor orders'],
      },
      {
        id: 'receiving',
        href: '/admin/purchase-orders',
        label: 'Receiving',
        description: 'Receive inventory, review exceptions, and close inbound shipments',
        icon: ClipboardCheck,
        aliases: ['receiving', 'inbound shipments', 'stock intake', 'restock', 'receive inventory', 'count stock', 'supplier shipment'],
      },
    ],
  },
  {
